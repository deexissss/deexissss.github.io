...
<style>
/* Le style visuel de notre bouton */
.btn-portfolio {
  display: inline-block;
  padding: 15px 30px;
  background-color: #6e5494; /* Violet sympa (couleur GitHub), vous pouvez changer ! */
  ...
  box-shadow: 0 4px 6px rgba(0,0,0,0.1); /* Petite ombre portée */
}

/* L'effet quand on passe la souris dessus (Hover) */
.btn-portfolio:hover {
  background-color: #5a437a; /* Devient un peu plus foncé */
  transform: translateY(-3px); /* Le bouton se soulève légèrement */
  box-shadow: 0 6px 12px rgba(0,0,0,0.15); /* L'ombre s'agrandit */
  text-decoration: none;
}
</style>
