...
<div id="minishell" class="modal-window">
  <div class="modal-content">
    ...
    <br>
    <a href="https://github.com/deexissss/minishell" target="_blank" style="background:#333; color:white; padding:10px 15px; border-radius:5px; text-decoration:none;">Voir le code source sur GitHub</a>
  </div>
</div>
